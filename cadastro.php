<html lang="pt-br">
  <head>
    ...
    <title>Cadastro - Bolicho Alegrete</title>
  </head>
  <body>
    <!-- Navbar -->
    <header
    ...
    <div class="row g-5 align-items-space-beet justify-content-center">
      <form class="col-auto" id="loginForm" action="./controller/createUser.php" method="POST">
