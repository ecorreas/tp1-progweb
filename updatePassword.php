<html lang="pt-br">
  <head>
    ...
    <title>Redefinir Senha - Bolicho Alegrete</title>
  </head>
  <body>
    <!-- Navbar -->
    <header
    ...
    <div class="row g-5 align-items-center justify-content-center">
      <form class="col-auto" id="loginForm" action="./controller/recoverPasswordController.php" method="POST">
      <legend>Redefinir Senha</legend>
                ...
                <div class="form-group">
                    ...
                    <input id="passConfirm" name="passConfirm" type="password" class="form-control" maxlength="50" id="exampleInputPassword2" placeholder="Confirm Password">
                </div>
